...
import { authLogin } from '../../state/actionCreators/authAction';
...
const LoginScreen = () => {
    ...
    const { form, onChange } = useForm({
        emai: 'nando@gmail.com',
        password: '123456'
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log(form.emai, form.password);
        dispatch(authLogin({uid: form.password, displayName: form.emai}));
    }
            ...
            <form onSubmit={handleSubmit}>
                <div className='auth__container-input-1'>
                    ...
                    <input
                        ...
                        value= {form.emai}
                        onChange={e => onChange('emai', e.target.value)}
                    />
                </div>
